...
from CircuitOS import InputShift, Encoder, IS31FL3731, MatrixOutputCharlie, Matrix, ShiftOutput, SliderADC, Encoders, Sliders
...
slider_l = SliderADC(Pins.POT_L, ADC.WIDTH_10BIT, min=220, max=720, ema_a=0.01, reverse=True)
slider_r = SliderADC(Pins.POT_R, ADC.WIDTH_10BIT, min=220, max=720, ema_a=0.01, reverse=True)
